...
//     * @param  mixed  $default
//     * @return ($key is null ? \Illuminate\Http\Request : ($key is string ? mixed : array<string, mixed>))| ($key is 'corporate' ? \Units\Corporates\Placed\Common\Models\CorporateModel : \Illuminate\Http\Request)
//     */
//    function request() {
//
//    }
