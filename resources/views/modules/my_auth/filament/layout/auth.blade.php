...
<x-filament-panels::layout.base :livewire="$livewire">
    <div class="h-[99vh] flex-row p-6 gap-8 mx-auto px-4 items-center">
        ...
        <div class="h-[95vh] grid grid-cols-1 md:grid-cols-2 gap-4 bg-white shadow-lg rounded-lg overflow-hidden">
            <!-- Left Section: Form -->
            <div class="@container">
                <div class="flex items-center relative overflow-hidden p-6 sm:hidden">
                    <img src="{{asset('assets/my/auth/images/auth-banner.png')}}"
                         alt="Arian ESCF auth banner" height="100%" class="h-[100%] object-cover">
                </div>
            </div>
