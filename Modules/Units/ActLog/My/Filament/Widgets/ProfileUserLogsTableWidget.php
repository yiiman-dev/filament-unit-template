...
namespace Units\ActLog\My\Filament\Widgets;
...
use Units\ActLog\My\Models\ActLog;
...
class ProfileUserLogsTableWidget extends TableWidget
{
    ...
    protected static ?string $heading='گزارش فعالیت کاربران';
        ...
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('ip_address')
                    ->label('آدرس IP'),
                TextColumn::make('actor_number')
                    ->extraAttributes(['style'=>'direction:ltr !important;text-align:center;justify-content: end;'])
                    ->label('کاربر اقدام کننده'),
            ])
