                        ...
                        Forms\Components\Section::make()
                            ->schema([
                                Forms\Components\TextInput::make('name')
                                    ...
                                    ->unique(
                                        ...
                                        modifyRuleUsing: function (Unique $rule) {
                                            ...
                                            $ite=Utils::isTenancyEnabled();
                                            if ($ite){
                                                /**
                                                 * @var CorporateModel $tenant
                                                 */
                                                $tfk=Utils::getTenantModelForeignKey();
                                                $tenant=Filament::getTenant();
                                                $tp=$tenant->getKeyName();
                                                $fv=$tenant?->{$tp};
                                            }

                                            return $ite ? $rule->where(
                                                $tfk,
                                                $fv
                                            ) : $rule;
                                        }
                                ...
                                Forms\Components\Select::make(config('permission.column_names.team_foreign_key'))
                                    ...
                                    ->options(
                                        fn(): Arrayable => Utils::getTenantModel() ? Utils::getTenantModel()::pluck(
                                            'name',
                                            'id'
                                        ) : collect()
                                    )
