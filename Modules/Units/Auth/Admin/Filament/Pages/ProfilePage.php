...
use Units\Users\Admin\Admin\Services\UserMetadataService;
...
class ProfilePage extends BasePage
{
    ...
    protected static string $view = 'admin_auth::filament.pages.profile';
    ...
    public function save(): void
    {
        ...
        unset($data['username']);
        $phone_number = Filament::auth()->user()->phone_number;
        $this->metadataService->actUpdateProfile(normalized_phone_number: $phone_number, data:$data);
