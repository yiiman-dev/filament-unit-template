...
<x-filament-panels::layout.base :livewire="$livewire">
    <div class="h-[99vh]  flex-row p-6 gap-8 mx-auto px-4 items-center" style="font-family: Shabnam">



        <div class="h-[95vh] grid grid-cols-1 md:grid-cols-2 gap-4 bg-white shadow-lg rounded-lg overflow-hidden">
            <!-- Left Section: Form -->
            <div class="@container sm:hidden md:block">
                <div class="flex items-center relative overflow-hidden p-6 h-full" style="background-position: center;background-size: cover ;background-image: url({{asset('assets/manage/auth/images/auth-banner.png')}})">
