...
//    use InteractsWithForms;
    ...
    protected static string $view = 'manage_auth::filament.pages.auth.verify';
    protected static string $layout = 'manage_auth::filament.layout.auth';
    ...
    public function mount(): void
    {
        ...
        if (empty($mobile)) {
            $this->redirect(Filament::getPanel('manage')->getUrl(), true);
        }
        $this->form->fill();
    }
}
