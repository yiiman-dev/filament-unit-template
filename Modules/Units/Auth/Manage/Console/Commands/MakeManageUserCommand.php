...
namespace Units\Auth\Manage\Console\Commands;
...
#[AsCommand(name: 'make:filament-user-manage')]
class MakeManageUserCommand extends Command
{
    protected $description = 'Create a new Filament Manage user - customized';

    protected $signature = 'make:filament-user-manage
