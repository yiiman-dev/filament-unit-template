...
class ManageAvatarProvider implements AvatarProvider
{
    ...
    {
        $this->publicPath = public_path('avatars/manage');
        $this->urlPath = '/avatars/manage';
    ...
    protected function generateFilename($name, $size): string
    {
    ...
    protected function createAvatarImage($name, $filePath, $size = 100): void
    {
