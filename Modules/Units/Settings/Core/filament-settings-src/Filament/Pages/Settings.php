...
class Settings extends Page
{
    ...
    public ?array $data = [];
    protected Setting|string $model = Setting::class;

    protected static ?string $navigationIcon = 'heroicon-o-cog';

    protected static string $view = 'common_settings::filament/pages/settings';
...
//    {
//        return static::$layout ?? 'common_settings::components.layout.index';
//    }

    public function getTitle() : string
    {
        return 'تنظیمات '.static::getNavigationLabel();
    }
    ...
    {
        return 'با موفقیت ذخیره شد';//__('common_settings::translations.notifications.saved');
    }
