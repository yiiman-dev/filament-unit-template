 ...
 *
 * کامپوننت لایوایر برای مدیریت ویژگی‌های زنده چت با قابلیت استفاده چندگانه
 * Livewire component for managing chat real-time features with multiple instance support
 */
class DynamicChatComponent extends Component
{
    use HasNotification;
