...
class GenerateCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $config->set('filament-shield', require base_path('Modules/Units/Shield/'.str($panel)->pascal().'/config/filament-shield.php'));
        $config->set('permission', require base_path('Modules/Units/Shield/'.str($panel)->pascal().'/config/permission.php'));
        $shield_config = config('filament-shield');
        $shield_permission = config('permission');

        $shield_permission = app(PermissionRegistrar::class)->setPermissionClass(config('permission.models.permission'));
